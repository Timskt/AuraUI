...
public class DrawerPage : ComponentPageBase
{
    ...
    {
        var rightDrawer = new Drawer { Placement = DrawerPlacement.Right, DrawerWidth = 300, Content = new StackPanel { Margin = new Thickness(20), Spacing = 12, Children = { new TextBlock { Text = "Right Drawer", FontWeight = FontWeight.SemiBold, FontSize = 18, Foreground = GetBrush("AuraForegroundBrush") }, new TextBlock { Text = "Drawer content goes here.", TextWrapping = TextWrapping.Wrap, Foreground = GetBrush("AuraForegroundSecondaryBrush", "#666666") } } } };
        var leftDrawer = new Drawer { Placement = DrawerPlacement.Left, DrawerWidth = 280, Content = new StackPanel { Margin = new Thickness(20), Spacing = 12, Children = { new TextBlock { Text = "Left Drawer", FontWeight = FontWeight.SemiBold, FontSize = 18, Foreground = GetBrush("AuraForegroundBrush") }, new TextBlock { Text = "Navigation or filter content.", TextWrapping = TextWrapping.Wrap, Foreground = GetBrush("AuraForegroundSecondaryBrush", "#666666") } } } };
